...
The number of shared aliases (which end in a shared domain like @addy.io) that you can create is limited to 10 on addy.io's free plan, 50 on their $1/month plan and unlimited on the $4/month plan (billed $3 for a year). They accept [cryptocurrency](https://addy.io/help/subscribing-with-cryptocurrency/) as payment or you can purchase a voucher code from [ProxyStore](https://addy.io/help/voucher-codes/), their official reseller.
...
You can purchase SimpleLogin anonymously via their official reseller, [ProxyStore](https://simplelogin.io/faq/).
